    ...
    internal class NodeMediatorSignForward : NodeMediator
    {
        ...
        internal override void ExecuteWorkItem()
        {
            try
            {
                ...
                {
                    if (ActivityForwardContext.ActivityResource.DynamicVariables.ContainsKey("SignForwardCompleteOrder"))
                    {
                        var completeOrder = ActivityForwardContext.ActivityResource.DynamicVariables["SignForwardCompleteOrder"];
                        if (!string.IsNullOrEmpty(completeOrder))
                            base.ActivityForwardContext.FromActivityInstance.CompleteOrder = float.Parse(completeOrder);
                    }
                    else if (ActivityForwardContext.ActivityResource.DynamicVariables["SignForwardType"] == "SignForwardParallel")
                    {
